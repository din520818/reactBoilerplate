  ...
  return (
    <section class="dnestw-bg-inherit dark:dnestw-bg-gray-900">
      <div class="dnestw-flex dnestw-flex-col dnestw-items-center dnestw-justify-center dnestw-px-6 dnestw-py-8 dnestw-mx-auto md:dnestw-h-screen lg:dnestw-py-0">
        <div class="dnestw-w-full dnestw-bg-orange-400 dnestw-p-6 dnestw-rounded-lg dnestw-shadow dark:dnestw-border md:dnestw-mt-0 sm:dnestw-max-w-md dark:dnestw-bg-gray-800 dark:dnestw-border-gray-700 sm:dnestw-p-8">
          <h2 class="dnestw-mb-1 dnestw-text-xl dnestw-font-bold dnestw-leading-tight dnestw-tracking-tight dnestw-text-gray-900 md:dnestw-text-2xl dark:dnestw-text-white">
            Change Password
          </h2>
          <form
          ...
          >
            <div>
              <label
                for="email"
                class="dnestw-block dnestw-mb-2 dnestw-text-sm dnestw-font-medium dnestw-text-gray-900 dark:dnestw-text-white"
              >
                Your email
              </label>
              <input
            ...
            <button
              type="submit"
              class="dnestw-w-full dnestw-bg-blue-400 dnestw-text-white bg-primary-600 hover:bg-primary-700 focus:dnestw-ring-4 focus:dnestw-outline-none focus:ring-primary-300 dnestw-font-medium dnestw-rounded-lg dnestw-text-sm dnestw-px-5 dnestw-py-2.5 dnestw-text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
            >
              Reset passwod
            </button>
          </form>
